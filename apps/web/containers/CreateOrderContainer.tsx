            ...
            <div className="grid grid-cols-12 gap-5">
              <div className="col-span-8">
                                    ...
                                    >
                                      ...
                                      <SelectContent>
                                        <SelectGroup>
                                          ...
                                          {singlevarentGroup?.variants?.length >
                                            0 && (
                                            <>
                ...
                <div className="bg-white p-5 rounded-lg shadow-md col-span-8 flex flex-col gap-2 mt-5">
                  ...
                  <div className="border-1 border-gray-700 p-2 space-y-2">
                    <div className="grid grid-cols-12">
                      <h5 className="col-span-3">Subtotal</h5>
                      {/* <h5 className="col-span-3">item</h5> */}
                      <h5 className="col-span-9 text-end">{`₹ ${form.watch("totalAmount")}.00`}</h5>
                    </div>
                    <div className="grid grid-cols-12">
                      <h5 className="col-span-3">Taxes</h5>
                      {/* <h5 className="col-span-3">item</h5> */}
                      <h5 className="col-span-9 text-end">{`₹ 0.00`}</h5>
                    </div>
                    <div className="grid grid-cols-12">
                      <h5 className="col-span-3 font-bold">Total</h5>
                      {/* <h5 className="col-span-3">item</h5> */}
                      <h5 className="col-span-9 text-end">{`₹ ${form.watch("totalAmount")}.00`}</h5>
                    </div>
                  </div>
