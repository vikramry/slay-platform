...
const ModelFieldFormContainer = ({ edit = false }: { edit?: boolean }) => {
  ...
  const [updateModelField, updateModelFieldResponse] =
    useLazyQuery(serverFetch);
  ...
  const [getModelFieldsLocal, getModelFieldsLocalResponse] =
    useLazyQuery(serverFetch);
  const [getModelFieldsForeign, getModelFieldsForeignResponse] =
    useLazyQuery(serverFetch);
  ...
  function getDefaultValue(defaultValue: string, type: string) {
  ...
  useEffect(() => {
    ...
    getModelFieldResponse.data,
    getModelFieldResponse.error,
    getModelFieldResponse.loading,
  ]);
  ...
  useEffect(() => {
    if (getModelFieldsLocalResponse.data) {
      form.setValue(
        "localField",
        getModelFieldResponse?.data?.getModelField?.localField
      );
    }
    ...
    getModelFieldsLocalResponse.data,
    getModelFieldsLocalResponse.error,
    getModelFieldsLocalResponse.loading,
  ]);
  ...
  useEffect(() => {
    if (getModelFieldsForeignResponse.data) {
      form.setValue(
        "foreignField",
        getModelFieldResponse.data?.getModelField?.foreignField
      );
    }
    ...
    getModelFieldsForeignResponse.data,
    getModelFieldsForeignResponse.error,
    getModelFieldsForeignResponse.loading,
  ]);
  ...
  useEffect(() => {
    ...
    updateModelFieldResponse.data,
    updateModelFieldResponse.error,
    updateModelFieldResponse.loading,
  ]);
  return (
    <Form {...form}>
      <Toaster />
